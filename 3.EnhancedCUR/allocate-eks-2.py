...
df_eks_ec2 = (df_eks
        ...
        .join(
            ...
            "left")
        .withColumn("usage_amount", col("usage_amount")*col("cpu_cost_ratio")*col("cpu_usage")/col("vcpus")+col("usage_amount")*(1-col("cpu_cost_ratio"))*col("mem_usage")/1024/1024/1024/col("memory_gb"))
...
if debug:
    (df_eks_dt.coalesce(1).write
        .mode("overwrite")
        .partitionBy(["usage_account","year","month"])
        .option("path", f"s3://{work_bucket}/data/enhanced_cur_allocate_eks_4/")
